...
const benefits = [
    {
        ...
        description: 'Controle visual com prevenção automática de choques de horário. Nunca mais dois pets no mesmo slot.',
        color: 'terracotta',
    },
    {
        icon: PawPrint,
        title: 'Cadastro completo',
        description: 'Ficha do pet com espécie, porte, raça e observações do tutor — tudo em um clique.',
        color: 'sage',
    },
    {
        icon: Wallet,
        title: 'Financeiro na mão',
        description: 'Receitas vs despesas, gráficos por categoria, PIX, cartão e saldo em tempo real.',
        color: 'terracotta',
    },
    {
        icon: Globe,
        title: 'Agendamento online',
        description: 'Página pública com sua marca para clientes verem disponibilidade e agendarem sozinhos.',
        color: 'sage',
    },
    {
        icon: Users,
        title: 'Equipe organizada',
        description: 'Convide banhistas e tosadores com permissões personalizadas por módulo.',
        color: 'terracotta',
    },
    {
        icon: BarChart3,
        title: 'Decisões com dados',
        description: 'Dashboard com faturamento por serviço, horário de pico e tendências do seu negócio.',
        color: 'sage',
    },
]
